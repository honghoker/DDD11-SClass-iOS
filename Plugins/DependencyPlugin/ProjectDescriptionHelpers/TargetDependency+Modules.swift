...
public extension TargetDependency {
    ...
    static func presentation(implements module: ModulePath.Presentation) -> Self {
        return .project(target: ModulePath.Presentation.name + module.rawValue, path: .presentation(implementation: module))
    }
    
    static func presentation(interface module: ModulePath.Presentation) -> Self {
        return .project(target: ModulePath.Presentation.name + module.rawValue + "Interface", path: .presentation(implementation: module))
    }
    
    static func presentation(tests module: ModulePath.Presentation) -> Self {
        return .project(target: ModulePath.Presentation.name + module.rawValue + "Tests", path: .presentation(implementation: module))
    }
    
    static func presentation(testing module: ModulePath.Presentation) -> Self {
        return .project(target: ModulePath.Presentation.name + module.rawValue + "Testing", path: .presentation(implementation: module))
    }
...
public extension TargetDependency {
    ...
    static func designSystem(implements module: ModulePath.DesignSystem) -> Self {
        return .project(target: ModulePath.DesignSystem.name + module.rawValue, path: .designSystem(implementation: module))
    }
}
